...
import galler from '../assets/Gallery/galler7.jpg'
...
const excursions = [
  {
    ...
    image:
      "https://www.zamaniproject.org/assets/images/nycc6052-1280x622.jpg",
  },
  {
    ...
    image:
      "https://www.onthegotours.com/repository/Elephants-in-Sri-Lanka--On-The-Go-Tours-345681493287055.jpg",
  },
  {
...
const Package = () => {
  ...
  return (
    <section className="w-full py-16 px-4 sm:px-6 lg:px-20 bg-gray-900">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        {excursions.map((item, index) => (
          <div
            key={index}
            className="fade-in-card bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-shadow duration-500 opacity-0 transform translate-y-10"
          >
