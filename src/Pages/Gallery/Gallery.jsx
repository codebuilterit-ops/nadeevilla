...
const Gallery = () => {
  return (
    <div className="w-full min-h-screen flex flex-col items-center justify-center -mt-16 px-4 sm:px-6 md:px-8">
      {/* ✅ Added px-4 sm:px-6 md:px-8 for responsive side padding */}

      <h2 className="text-3xl font-semibold mb-10 text-gray-800 text-center">
        Travel Moments Gallery
      </h2>

      <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 max-w-6xl w-full">
